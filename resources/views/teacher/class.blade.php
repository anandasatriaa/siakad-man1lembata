        ...
        <div class="page-title">
            <div class="row align-items-center">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Daftar Kelas Yang Saya Ajar</h3>
                    <p class="text-subtitle text-muted">Semua informasi kelas yang diajar berada di sini</p>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="card-header bg-light">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h3 class="mb-0 text-primary">
                                                ...
                                                {{-- <span class="badge bg-secondary">Kategori: {{ $classData['class']->category }}</span> --}}
                                            </h3>
                                            <div>
                                                            ...
                                                            <td>
                                                                @if($student->photo)
                                                                    <img src="{{ asset('storage/' . $student->photo) }}"
                                                                        alt="Foto {{ $student->full_name }}" class="rounded-circle"
                                                                        width="40" height="40">
                                                                @else
