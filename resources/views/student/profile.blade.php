        ...
        <div class="page-title">
            <div class="row align-items-center">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Profil Siswa</h3>
                    <p class="text-subtitle text-muted">Semua informasi profil siswa berada di sini</p>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}"
                                            required readonly>
                                        <small class="form-text text-muted">Untuk mengubah, silakan hubungi admin.</small>
                                        @error('name')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="full_name" id="full_name"
                                            value="{{ old('full_name', $student->full_name) }}" required readonly>
                                        <small class="form-text text-muted">Untuk mengubah, silakan hubungi admin.</small>
                                        @error('full_name')
                                            <div class="error-text">{{ $message }}</div>
                                        @enderror
